...
func (e *CloudWatchExecutor) handleGetLogEvents(ctx context.Context, logsClient *cloudwatchlogs.CloudWatchLogs, parameters *simplejson.Json) (*data.Frame, error) {
...
func (e *CloudWatchExecutor) handleDescribeLogGroups(ctx context.Context, logsClient *cloudwatchlogs.CloudWatchLogs, parameters *simplejson.Json) (*data.Frame, error) {
...
func (e *CloudWatchExecutor) executeStartQuery(ctx context.Context, logsClient *cloudwatchlogs.CloudWatchLogs, parameters *simplejson.Json, timeRange *tsdb.TimeRange) (*cloudwatchlogs.StartQueryOutput, error) {
...
func (e *CloudWatchExecutor) handleStartQuery(ctx context.Context, logsClient *cloudwatchlogs.CloudWatchLogs, parameters *simplejson.Json, timeRange *tsdb.TimeRange, refID string) (*data.Frame, error) {
	...
	clientRegion := logsClient.Config.Region
	if clientRegion == nil {
		clientRegion = aws.String("default")
	}

	dataFrame.Meta = &data.QueryResultMeta{
...
func (e *CloudWatchExecutor) executeStopQuery(ctx context.Context, logsClient *cloudwatchlogs.CloudWatchLogs, parameters *simplejson.Json) (*cloudwatchlogs.StopQueryOutput, error) {
...
func (e *CloudWatchExecutor) handleStopQuery(ctx context.Context, logsClient *cloudwatchlogs.CloudWatchLogs, parameters *simplejson.Json) (*data.Frame, error) {
...
func (e *CloudWatchExecutor) executeGetQueryResults(ctx context.Context, logsClient *cloudwatchlogs.CloudWatchLogs, parameters *simplejson.Json) (*cloudwatchlogs.GetQueryResultsOutput, error) {
...
func (e *CloudWatchExecutor) handleGetQueryResults(ctx context.Context, logsClient *cloudwatchlogs.CloudWatchLogs, parameters *simplejson.Json, refID string) (*data.Frame, error) {
...
func (e *CloudWatchExecutor) handleGetLogGroupFields(ctx context.Context, logsClient *cloudwatchlogs.CloudWatchLogs, parameters *simplejson.Json, refID string) (*data.Frame, error) {
